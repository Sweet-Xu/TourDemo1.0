package com.cjhlearn.tourdemo10.adapter;
...
import com.cjhlearn.tourdemo10.LoginMainActivity;
import com.cjhlearn.tourdemo10.R;
import com.cjhlearn.tourdemo10.TabGroupActivity;

import java.util.ArrayList;


public class LaunchSimpleAdapter extends PagerAdapter {
    private static final int LOGIN_ACT_RESULT_FLAG=0x02;
...
//            Button btn_start = view.findViewById(R.id.btn_start);
            ...
            // 如果是最后一个引导页，则显示入口按钮，以便用户点击按钮进入首页,如果尚未登录，则跳转至登陆页面
...
//                        if (v.getId() == R.id.btn_start) {
                            //TODO 启动自动登录服务，当自动登录返回Ture，则表示登录成功，自动跳入首页，如果出现非零错误，则跳入登录界面
