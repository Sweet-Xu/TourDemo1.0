...
import com.cjhlearn.tourdemo10.util.ViewUtil;


@SuppressLint("DefaultLocale")
public class LoginMainActivity extends AppCompatActivity implements OnClickListener {

    public static final String EXTRA_STRING_RETURN_NAME="extraStringName";//返回值键值
    ...
    private void ReturnFatherActivity(){
        Log.i("LoginMainActivity", "ReturnFatherActivity: willBeReturnFatherAct");
        Intent iData=new Intent();
        iData.putExtra(EXTRA_STRING_RETURN_NAME, et_phone.getText().toString());
